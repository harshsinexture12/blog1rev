...
def show_my_post():
    '''
    this fucntion is gonna show all the posts made by the user by logging in into his account
    with all the details such as authorid, date, pic 
    '''
    if g.email: 
...
def show_all_post():
    '''
    this function is gonna show all the posts made by all the users present in the blog network
    '''
    if g.email: 
...
def add_post():
    '''
    Using this fuctn the user can make a post into the blog throgh his account
    '''
